...
public class Main {
	...
	public static void main(String[] args) {
		...
		Address add2B = new Address("2210 Burlington", "Chicago", "IL", "52589");
		...
		c[0]=new Customer("Deepa", "Sapkota","378837j", add1A, add1B);
		c[1]=new Customer("HAri", "Silwal","33e83", add2A,add2B);
		...
		for(Customer ct:c){
			System.out.println("Customers are  " + ct.toString()+"/n");
		}
	}
